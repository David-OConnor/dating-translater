...
SECRET_KEY = '6duxmp_hoshmiz5!z$o9jaf@z3-&tuz0fyvob$(t)zl#1+u0qg'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'dating-translator.herokuapp.com', 'schedule-train.com',
                 'www.dating-translator.com']
